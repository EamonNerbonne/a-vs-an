...
namespace AvsAnLib {
	public static class AvsAn {
		...
		/// 
		/// By Eamon Nerbonne; feedback shouldb reported to http://code.google.com/p/a-vs-an/
		/// </summary>
		/// <param name="word">The word to test, excluding preceding quotation marks.</param>
		/// <returns>A result indicating "a" or "an" including some wikipedia-derived statistics.</returns>
		public static Result Query(string word) { return Query(root, word, 0); }
