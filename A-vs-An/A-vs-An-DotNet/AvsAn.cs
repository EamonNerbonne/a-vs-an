...
namespace AvsAnLib {
	public static class AvsAn {
		...
		public struct Result {
			...
			/// </summary>
			public string Prefix { get { return Depth > Word.Length ? Word + new string(' ', Depth - Word.Length) : Word.Substring(0, Depth); } }
			/// <summary>
			/// The tested word.
			/// </summary>
		...
		/// 
		/// By Eamon Nerbonne; feedback can be reported to http://code.google.com/p/a-vs-an/
		/// </summary>
