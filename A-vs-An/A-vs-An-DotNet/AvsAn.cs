...
namespace AvsAnLib {
	public static class AvsAn {
		...
		public struct Result {
			...
			public Result(int aCount, int anCount, string prefix) { this.aCount = aCount; this.anCount = anCount; this.Prefix = prefix; }
		}

		public static Result Query(string word) { return root.Query(word, 0); }
